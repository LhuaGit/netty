...
public final class NioChannelOption<T> extends ChannelOption<T> {
    ...
    // It's important to not use java.nio.channels.NetworkChannel in the method signature directly as this will lead
    // to errors during class-loading when using Java6.
    //
